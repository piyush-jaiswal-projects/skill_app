...
-(id)initWithFrame:(CGRect)frame normalImage:(UIImage*)passiveImage andPressedImage:(UIImage*)activeImage withScrollview:(UIScrollView*)scrView
{
    ...
    if (self)
    {
        ...
        _menuTable = [[UITableView alloc]initWithFrame:CGRectMake((SCREEN_WIDTH/6), 0, 0.82*SCREEN_WIDTH,SCREEN_HEIGHT-30 )];
        //_menuTable = [[UITableView alloc]initWithFrame:CGRectMake(20, 0, 0.75*SCREEN_WIDTH,SCREEN_HEIGHT-30 )];
