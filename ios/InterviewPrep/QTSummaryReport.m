...
@implementation QTSummaryReport
...
-(void)loadSummaryReport
{
    ...
    for (int i=0; i < [self.trackOriginalArr count]; i++) {
        ...
        {
            UIView * movieView = [[UIView alloc]initWithFrame:CGRectMake(0, 0,SCREEN_WIDTH,questionAudioView.frame.size.height)];
...
//            int  local_questheight1 = [self heightForText:_attributedString.string font:SampleLbl.font withinWidth:SampleLbl.frame.size.width]+MC_MMC_TEST_TOP_BOTTOM_PADDING;
    ...
    tryAgainBtn = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/10, mainHeight+70, 8*(SCREEN_WIDTH/10),40)];
    tryAgainBtn.tag =3;
