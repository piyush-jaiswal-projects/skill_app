...
@interface WTComponant ()<WKUIDelegate,WKNavigationDelegate,TTGTextTagCollectionViewDelegate,UITableViewDataSource,UITableViewDelegate,DragAndDropTableViewDataSource,DragAndDropTableViewDelegate,UIGestureRecognizerDelegate>
{
...
-(void)finalClickSubmit
{
    ...
    [self calculateAnswerAndMakeJson];
        ...
        if([[data valueForKey:NATIVE_JSON_KEY_ENDTIME] longLongValue] >= [[data valueForKey:NATIVE_JSON_KEY_STARTTIME] longLongValue] )
        {
            ...
            WTSummaryReport * pteObj = [[WTSummaryReport alloc]initWithNibName:@"WTSummaryReport" bundle:nil];
            ...
            for (NSDictionary * obj  in ansTrackArray) {
                if([[obj valueForKey:@"type"] isEqualToString:@"es"])
                    [arr addObject:obj];
            }
...
//                        [audioView addSubview:audioViewPlayer.view];
        ...
        if( [[[[question valueForKey:@"format"] valueForKey:@"delivery"]valueForKey:@"text"]isEqualToString:@"es"])
        {
...
//                 else
//                 {
                    [reviewBtn setTitle:@"Model Answer" forState:UIControlStateNormal];
                // }
...
//            questionView.attributedText = attributedString;
     ...
     AnswerAudioView = [[UIView alloc]initWithFrame:CGRectMake(10, 30, answerView.frame.size.width-20, 20)];
...
//     [[AnswerAudioView layer] setCornerRadius:0];
     ...
     UILabel * SampleLbl = [[UILabel alloc]initWithFrame:CGRectMake(0, 5, AnswerAudioView.frame.size.width, 20)];
      ...
      NSString* newString = [esTextView.text stringByReplacingOccurrencesOfString:@"&#38;" withString:@"&"];
      NSString* newString3 = [newString stringByReplacingOccurrencesOfString:@"&lt;" withString:@"<"];
      NSString* newString1 = [newString3 stringByReplacingOccurrencesOfString:@"&gt;" withString:@">"];
      //NSString* newString2 = [newString1 stringByReplacingOccurrencesOfString:@"\t" withString:@"<br/>"];
      NSString* newString4 = [newString1 stringByReplacingOccurrencesOfString:@"\n" withString:@""];
      ...
      NSString* newString8 = [newString7 stringByAppendingString:@"<br/>"];
      NSArray * brCounter = [newString8 componentsSeparatedByString:@"<br/>"];
      NSString * str = [[NSString alloc]initWithFormat:@"<div><font face=\"Helvetica\" color=\"#4e4e4e\" style=\"padding:10px; font-size:13px;\">%@</font></div>",newString8];
      NSAttributedString *_attributedString = [[NSAttributedString alloc]
                                               initWithData: [str dataUsingEncoding:NSUnicodeStringEncoding]
                                               options: @{ NSDocumentTypeDocumentAttribute: NSHTMLTextDocumentType}
                                               documentAttributes: nil
