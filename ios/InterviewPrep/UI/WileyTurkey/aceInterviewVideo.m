...
@implementation aceInterviewVideo
...
- (void)viewDidLoad {
    ...
    NSURL *websiteUrl = [NSURL URLWithString:[ACE_VIDEO stringByAddingPercentEscapesUsingEncoding:NSUTF8StringEncoding]];
