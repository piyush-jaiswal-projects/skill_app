...
@interface Assessment : baseViewController<AVAudioPlayerDelegate,UITextViewDelegate,UITextFieldDelegate,AVAudioRecorderDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>{
