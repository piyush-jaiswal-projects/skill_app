...
- (void)viewDidLoad {
    ...
    NSMutableString *url = [[NSMutableString alloc]initWithFormat:@"%@?user_id=%@&platform=EMP&product=%@&device=iOS&device_id=%@&client_id=%@",FEEDBACKURL,userId,myString,[appDelegate.engineObj getIMEINumber],CLIENT];
