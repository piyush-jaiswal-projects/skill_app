...
-(void)initView:(CGRect)frame{
    ...
    [self setEmptyLineColor:[UIColor redColor]];
    [self setEmptyLineStrokeColor:[UIColor whiteColor]];
    [self setFontColor:[UIColor blackColor]];
    [self setEmptyLineWidth:6.f];
    [self setProgressLineWidth:6.f];
