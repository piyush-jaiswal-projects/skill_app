...
@interface LiqWebViewJavascriptBridge ()


@end


@implementation LiqWebViewJavascriptBridge {
    WVJB_WEBVIEW_TYPE* _webView;
    id _webViewDelegate;
...
+ (instancetype)bridgeForWebView:(WVJB_WEBVIEW_TYPE*)webView webViewDelegate:(WVJB_WEBVIEW_DELEGATE_TYPE*)webViewDelegate handler:(WVJBHandler)messageHandler resourceBundle:(NSBundle*)bundle
{
    ...
    //[webView stringByEvaluatingJavaScriptFromString: @"document.body.style.fontFamily = 'Helvetica'"];
    LiqWebViewJavascriptBridge* bridge = [[LiqWebViewJavascriptBridge alloc] init];
...
- (void)_dispatchMessage:(WVJBMessage*)message {
    ...
    if ([[NSThread currentThread] isMainThread]) {
        ...
        WVJB_WEBVIEW_TYPE* strongWebView = _webView;
...
- (void)webView:(WebView *)webView didFinishLoadForFrame:(WebFrame *)frame
{
    ...
    if (![[webView stringByEvaluatingJavaScriptFromString:@"typeof WebViewJavascriptBridge == 'object'"] isEqualToString:@"true"]) {
        ...
        NSString *filePath = [bundle pathForResource:@"LiqWebViewJavascriptBridge.js" ofType:@"txt"];
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    typeof(_webViewDelegate) strongDelegate = _webViewDelegate;
