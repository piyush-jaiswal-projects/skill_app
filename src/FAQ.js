...
// import {ScrollView,View,ImageBackground,Image,StyleSheet,Text,TextInput,Dimensions,TouchableOpacity} from 'react-native';
...
//       app_id:"1",
//      }
//      this.loadAPI('1',global.base_url+'getFAQ',"GET",body_data);
//   }
...
//             </View>
//       </LinearGradient>
//       <View style={[styles.cornerContainer,{marginBottom:0,height:screenHeight,flex:1,marginTop:-100}]}>
//       <WebView
    ...
    return (
      <View style={{ height: "100%" }}>
        <View style={[styles.mainContainer, { height: "100%" }]}>
          ...
          <View style={[styles.cornerContainer, { padding:10,marginBottom: 0, height: "100%", flex: 1, marginTop: -100 }]}>
            <WebView
              ...
              style={{ height: "100%" }}
              originWhitelist={['*']}
              source={{ uri: global.base_url+'doc/faq.php' }}
